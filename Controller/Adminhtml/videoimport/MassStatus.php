...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('videoimport');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('WebTechnologyCodes\VideoImport\Model\Videoimport')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('videoimport/*/index');
    }

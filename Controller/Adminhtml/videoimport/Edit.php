...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('WebTechnologyCodes_VideoImport::Videoimport')
            ->addBreadcrumb(__('WebTechnologyCodes VideoImport'), __('WebTechnologyCodes VideoImport'))
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('videoimport', $model);
